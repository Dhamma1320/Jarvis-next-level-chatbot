...
# Get the input language setting (e.g., "en-US", "hi-IN")
...
# Replace the placeholder with actual input language
...
service = Service(ChromeDriverManager(driver_version="140.0.7339.81").install())
